...
var _larribas$elm_image_slider$ImageSlider$onKeyDown = function (keysAndMsgs) {
	var handle = function (keyCode) {
...
var _larribas$elm_image_slider$ImageSlider$viewThumbnail = F5(
	function (conf, offset, focusedSlide, i, image) {
		return A2(
			_elm_lang$html$Html$img,
			{
				ctor: '::',
				_0: _elm_lang$html$Html_Attributes$src(
					conf.thumbnailUrl(image)),
				_1: {
					ctor: '::',
					...
					_1: {
						...
						_1: {
							...
							_0: _elm_lang$html$Html_Events$onClick(
								_larribas$elm_image_slider$ImageSlider$ShowSlide(i + offset)),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _larribas$elm_image_slider$ImageSlider$viewThumbnails = F3(
		...
		return A2(
			...
			_elm_lang$core$Array$toList(
				A2(
					...
					A3(_larribas$elm_image_slider$ImageSlider$viewThumbnail, conf, offset, focusedSlide),
					slidesToShow)));
	});
var _larribas$elm_image_slider$ImageSlider$view = F3(
	function (conf, slides, _p3) {
		var _p4 = _p3;
		var _p7 = _p4._0;
		...
		return A2(
			_elm_lang$html$Html$div,
			{
				...
				_1: {
					ctor: '::',
					_0: _larribas$elm_image_slider$ImageSlider$onKeyDown(
						_elm_lang$core$Dict$fromList(
							{
								ctor: '::',
								_0: {
						...
						_0: A2(
							_elm_lang$html$Html$i,
							{
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(
										_larribas$elm_image_slider$ImageSlider$ShowSlide(previous)),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$classList(
											{
								...
								_0: A2(
									_elm_lang$html$Html$i,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(
												_larribas$elm_image_slider$ImageSlider$ShowSlide(next)),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$classList(
													{
...
var _user$project$Icons$svgFeatherIcon = function (className) {
...
var _user$project$Icons$arrowUpRight = A2(
...
var _user$project$Icons$facebook = A2(
	_user$project$Icons$svgFeatherIcon,
	'facebook',
	{
		ctor: '::',
...
var _user$project$Icons$instagram = A2(
	_user$project$Icons$svgFeatherIcon,
	'instagram',
	{
		ctor: '::',
...
var _user$project$Icons$link = A2(
	_user$project$Icons$svgFeatherIcon,
	'link',
	{
		ctor: '::',
...
var _user$project$Icons$mail = A2(
	_user$project$Icons$svgFeatherIcon,
	'mail',
	{
		ctor: '::',
...
var _user$project$Icons$mapPin = A2(
	_user$project$Icons$svgFeatherIcon,
	'map-pin',
	{
		ctor: '::',
...
var _user$project$Icons$youtube = A2(
	_user$project$Icons$svgFeatherIcon,
	'youtube',
	{
		ctor: '::',
...
var _user$project$Calendar$headOrEmpty = function (list) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		'',
		_elm_lang$core$List$head(list));
};
var _user$project$Calendar$getOrEmpty = F2(
...
var _user$project$Calendar$encode = F2(
	function (list, obj) {
		return A2(
			_elm_lang$core$List$map,
			function (i) {
...
var _user$project$Calendar$titleRow = F2(
...
var _user$project$Calendar$dateParagraph = function (string) {
...
var _user$project$Calendar$texta = function (a) {
	return _elm_lang$html$Html$text(
		_elm_lang$core$Basics$toString(a));
};
var _user$project$Calendar$linkOrParagraph = F3(
...
var _user$project$Calendar$rows = F2(
			...
			function () {
				...
				if (_p3 === 1) {
					return {
						ctor: '::',
						_0: A2(
							_user$project$Calendar$titleRow,
							'h3',
							A2(
								_elm_lang$core$String$left,
								4,
								_user$project$Calendar$headOrEmpty(list))),
						_1: {ctor: '[]'}
					};
				} else {
					var array = _user$project$Calendar$getOrEmpty(
					...
					return {
						...
						_0: A2(
							...
							{
								ctor: '::',
								_0: _user$project$Calendar$dateParagraph(
									array(0)),
								_1: {ctor: '[]'}
							}),
						_1: {
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									ctor: '::',
									_0: A3(
										_user$project$Calendar$linkOrParagraph,
										array(1),
										array(2),
										settings.icons.event),
									_1: {ctor: '[]'}
								}),
							_1: {
								ctor: '::',
...
var _user$project$Calendar$Event = F5(
	function (a, b, c, d, e) {
		return {date: a, eventName: b, eventUrl: c, locationName: d, locationUrl: e};
	});

var _user$project$Types$Url = F2(
	function (a, b) {
		return {de: a, en: b};
	});
var _user$project$Types$Image = F2(
	function (a, b) {
		return {src: a, alt: b};
	});
var _user$project$Types$MaybeUrl = F2(
	function (a, b) {
		return {name: a, url: b};
	});
...
var _user$project$Types$MarkdownOptions = F4(
	function (a, b, c, d) {
		return {githubFlavored: a, defaultHighlighting: b, sanitize: c, smartypants: d};
	});
var _user$project$Types$SliderMsg = function (a) {
...
var _user$project$U$replace = F3(
	function (toReplace, replacement, string) {
		return A2(
			_elm_lang$core$String$join,
			replacement,
			A2(_elm_lang$core$String$split, toReplace, string));
	});
var _user$project$U$remove = F2(
...
var _user$project$Main$firstImage = function (images) {
	return function (_) {
		...
		A2(
			_elm_lang$core$Maybe$withDefault,
			A2(_user$project$Types$Image, '', ''),
			_elm_lang$core$List$head(images)));
};
var _user$project$Main$onEscape = function (msg) {
	var handle = function (keyCode) {
		return _elm_lang$core$Native_Utils.eq(keyCode, 27) ? _elm_lang$core$Json_Decode$succeed(msg) : _elm_lang$core$Json_Decode$fail(
			A2(
				_elm_lang$core$Basics_ops['++'],
				'Unexpected keyCode ',
				_elm_lang$core$Basics$toString(keyCode)));
...
var _user$project$Main$gallery = function (model) {
	var sliderConf = {
		originalUrl: function (_) {
			return _.src;
		},
		thumbnailUrl: function (_) {
			return _.src;
		},
		alt: function (_) {
			return _.alt;
								...
								_elm_lang$html$Html$img,
								{
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$src(
												_user$project$Main$firstImage(model.content.images)),
											_1: {ctor: '[]'}
										}
									}
								},
						...
						return A2(
							...
							},
							{
								...
								_0: A2(
									...
									_user$project$Types$SliderMsg,
									A3(
										_larribas$elm_image_slider$ImageSlider$view,
										sliderConf,
										_elm_lang$core$Array$fromList(model.content.images),
										_p1._0)),
								_1: {
									ctor: '::',
									_0: A2(
...
var _user$project$Main$options = _elm_lang$core$Native_Utils.update(
	_user$project$Main$defaultOptions,
	{
		githubFlavored: _elm_lang$core$Maybe$Just(
			{tables: true, breaks: false})
	});
var _user$project$Main$toMarkdown = function (userInput) {
	return A3(
								...
								_0: A2(
									_elm_lang$html$Html$img,
									{
										...
										_0: _elm_lang$html$Html_Attributes$class(
											_user$project$U$u(
												{filter: 'invert', height: '1', align: 'inline'})),
										_1: {
											ctor: '::',
...
var _user$project$Main$toggleLanguage = function (model) {
				...
				if (_p5.ctor === 'Just') {
					return {
						...
						_0: _elm_lang$core$Native_Utils.update(
							model,
							{
								slider: _elm_lang$core$Maybe$Just(
									A2(_larribas$elm_image_slider$ImageSlider$update, _p3._0, _p5._0))
							}),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				} else {
