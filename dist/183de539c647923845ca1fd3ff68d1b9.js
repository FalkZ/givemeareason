...
(function () {
    ...
    */
	...
	var _user$project$Calendar$titleRow = F2(function (element, title) {
		return A2(_elm_lang$html$Html$tr, { ctor: '[]' }, {
			...
			_0: A2(_elm_lang$html$Html$td, {
				...
				ctor: '::',
				_0: A3(_elm_lang$html$Html$node, element, { ctor: '[]' }, {
					ctor: '::',
	...
	var _user$project$Calendar$defaultSettings = {
		icons: { event: _user$project$Icons$link, location: _user$project$Icons$mapPin },
		text: {
	...
	var _user$project$Calendar$dateParagraph = function _user$project$Calendar$dateParagraph(string) {
		...
		if (_p0.ctor === 'Ok') {
			var _p1 = _p0._0;
			return A2(_elm_lang$html$Html$p, { ctor: '[]' }, {
				ctor: '::',
			...
			return A2(_elm_lang$html$Html$p, { ctor: '[]' }, { ctor: '[]' });
		}
	};
	...
	var _user$project$Calendar$rows = F2(function (settings, list) {
		return A2(_elm_lang$html$Html$tr, { ctor: '[]' }, function () {
	...
	var _user$project$Calendar$calendar = F3(function (now, altText, events) {
		...
		var year = function year(event) {
			return {
				ctor: '::',
				_0: A2(_elm_lang$core$Basics_ops['++'], A2(_elm_lang$core$String$left, 4, headOrEmpty(event)), 'Year'),
				_1: { ctor: '[]' }
			};
		};
		var process = function process(data) {
			return A2(_elm_lang$core$List$map, _user$project$Calendar$rows(_user$project$Calendar$defaultSettings), _elm_lang$core$List$reverse(_elm_lang$core$Set$toList(_elm_lang$core$Set$fromList(A2(listPrepend, year, A2(_elm_lang$core$List$map, _user$project$Calendar$createComparable, data))))));
		};
		...
		return A2(_elm_lang$html$Html$table, { ctor: '[]' }, {
			ctor: '::',
			_0: A2(_elm_lang$html$Html$tbody, { ctor: '[]' }, _elm_lang$core$List$concat({
				ctor: '::',
				_0: {
					ctor: '::',
	...
	var _user$project$Calendar$Event = F5(function (a, b, c, d, e) {
		return { date: a, eventName: b, eventUrl: c, locationName: d, locationUrl: e };
	});
	...
	var _user$project$Types$Model = F3(function (a, b, c) {
		return { content: a, language: b, slider: c };
	});
	...
	var _user$project$Types$CloseSlider = { ctor: 'CloseSlider' };
	var _user$project$Types$OpenSlider = { ctor: 'OpenSlider' };
			...
			_0: A2(_elm_lang$html$Html$header, { ctor: '[]' }, {
				...
				_0: A2(_elm_lang$html$Html$a, {
					...
					_1: {
						...
						_0: A2(_elm_lang$html$Html$img, {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class(_user$project$U$u({ filter: 'invert', height: '1', align: 'inline' })),
							_1: {
								ctor: '::',
			...
			_1: {
				...
				_1: {
					...
					_0: A2(_elm_lang$html$Html$main_, {
						...
						_1: {
							ctor: '::',
							_0: A2(_elm_lang$html$Html$blockquote, { ctor: '[]' }, {
								ctor: '::',
	...
	var _user$project$Main$update = F2(function (msg, model) {
		...
		switch (_p3.ctor) {
			...
			case 'NewContent':
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(model, { content: _p3._0 }),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'OpenSlider':
						...
						return A2(_elm_lang$core$Json_Decode$andThen, function (logo) {
							return A2(_elm_lang$core$Json_Decode$andThen, function (now) {
								return A2(_elm_lang$core$Json_Decode$andThen, function (images) {
									return _elm_lang$core$Json_Decode$succeed({ news: news, eventsAltText: eventsAltText, events: events, about: about, contact: contact, logo: logo, now: now, images: images });
									...
									return A2(_elm_lang$core$Json_Decode$andThen, function (alt) {
										return _elm_lang$core$Json_Decode$succeed({ src: src, alt: alt });
							...
							return A2(_elm_lang$core$Json_Decode$andThen, function (eventUrl) {
								return A2(_elm_lang$core$Json_Decode$andThen, function (locationName) {
									return A2(_elm_lang$core$Json_Decode$andThen, function (locationUrl) {
										return _elm_lang$core$Json_Decode$succeed({ date: date, eventName: eventName, eventUrl: eventUrl, locationName: locationName, locationUrl: locationUrl });
...
},{"process":43}],9:[function(require,module,exports) {
'use strict';
...
},{"./common":27}],17:[function(require,module,exports) {
'use strict';
...
},{"./exception":19}],18:[function(require,module,exports) {
'use strict';
...
},{"./common":27,"./exception":19,"./type":17}],26:[function(require,module,exports) {
'use strict';
...
},{"../schema":18,"../type/str":26,"../type/seq":25,"../type/map":28}],29:[function(require,module,exports) {
'use strict';
...
},{"../common":27,"../type":17}],32:[function(require,module,exports) {
'use strict';
...
},{"../common":27,"../type":17}],21:[function(require,module,exports) {
...
},{"../schema":18,"./failsafe":20,"../type/null":29,"../type/bool":30,"../type/int":31,"../type/float":32}],22:[function(require,module,exports) {
...
},{"../schema":18,"./json":21}],33:[function(require,module,exports) {
'use strict';
...
},{"../type":17}],35:[function(require,module,exports) {
'use strict';
...
},{"../type":17}],36:[function(require,module,exports) {
'use strict';
...
},{"../type":17}],37:[function(require,module,exports) {
'use strict';
...
},{"../type":17}],38:[function(require,module,exports) {
'use strict';
...
},{"../schema":18,"./core":22,"../type/timestamp":33,"../type/merge":35,"../type/binary":34,"../type/omap":36,"../type/pairs":37,"../type/set":38}],41:[function(require,module,exports) {
'use strict';
...
},{"../../type":17}],39:[function(require,module,exports) {
'use strict';
...
},{"../../type":17}],40:[function(require,module,exports) {
'use strict';
...
},{"../schema":18,"./default_safe":23,"../type/js/undefined":41,"../type/js/regexp":39,"../type/js/function":40}],15:[function(require,module,exports) {
'use strict';
...
},{"./common":27,"./exception":19,"./mark":42,"./schema/default_safe":23,"./schema/default_full":24}],16:[function(require,module,exports) {
'use strict';
...
},{"./common":27,"./exception":19,"./schema/default_full":24,"./schema/default_safe":23}],14:[function(require,module,exports) {
'use strict';
...
},{"./js-yaml/loader":15,"./js-yaml/dumper":16,"./js-yaml/type":17,"./js-yaml/schema":18,"./js-yaml/schema/failsafe":20,"./js-yaml/schema/json":21,"./js-yaml/schema/core":22,"./js-yaml/schema/default_safe":23,"./js-yaml/schema/default_full":24,"./js-yaml/exception":19}],12:[function(require,module,exports) {
'use strict';
...
},{"./lib/js-yaml.js":14}],5:[function(require,module,exports) {
module.exports="/dist/669909cf55e4f191d9834de3db36daa3.svg";
...
},{"process":43}],3:[function(require,module,exports) {
'use strict';
...
var _joker = require('./joker.svg');

var _joker2 = _interopRequireDefault(_joker);
		...
		if (hash) {
			try {
				(0, _jquery2.default)('html, body').animate({
					scrollTop: (0, _jquery2.default)(hash).offset().top - 200
				}, 600);
			} catch (error) {
...
},{"./Main.js":4,"./registerServiceWorker":9,"js-yaml":12,"./joker.svg":5,"./main.styl":6,"./header.styl":7,"./Gallery.styl":8,"jquery":13}],44:[function(require,module,exports) {
...
//# sourceMappingURL=/dist/183de539c647923845ca1fd3ff68d1b9.map